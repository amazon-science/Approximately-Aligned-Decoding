 ...
 *
 * EDITED: Line 1150 changes the behavior on error nodes to perform slightly better for hallucination detection
 */
...
import * as AnalyzerNodeInfo from '@zzzen/pyright-internal/dist/analyzer/analyzerNodeInfo.js';
import {
    Declaration,
    DeclarationType,
    FunctionDeclaration,
    ...
    VariableDeclaration,
} from '@zzzen/pyright-internal/dist/analyzer/declaration.js';
import {isDefinedInFile} from '@zzzen/pyright-internal/dist/analyzer/declarationUtils.js';
import {ImportedModuleDescriptor, ImportResolver} from '@zzzen/pyright-internal/dist/analyzer/importResolver.js';
import {ImportResult} from '@zzzen/pyright-internal/dist/analyzer/importResult.js';
import {getParameterListDetails, ParameterKind} from '@zzzen/pyright-internal/dist/analyzer/parameterUtils.js';
import * as ParseTreeUtils from '@zzzen/pyright-internal/dist/analyzer/parseTreeUtils.js';
import {getCallNodeAndActiveParameterIndex} from '@zzzen/pyright-internal/dist/analyzer/parseTreeUtils.js';
import {getScopeForNode} from '@zzzen/pyright-internal/dist/analyzer/scopeUtils.js';
import {isStubFile, SourceMapper} from '@zzzen/pyright-internal/dist/analyzer/sourceMapper.js';
import {Symbol, SymbolTable} from '@zzzen/pyright-internal/dist/analyzer/symbol.js';
import * as SymbolNameUtils from '@zzzen/pyright-internal/dist/analyzer/symbolNameUtils.js';
import {
    getLastTypedDeclarationForSymbol,
    isVisibleExternally
} from '@zzzen/pyright-internal/dist/analyzer/symbolUtils.js';
import {getTypedDictMembersForClass} from '@zzzen/pyright-internal/dist/analyzer/typedDicts.js';
import {getModuleDocStringFromUris, isBuiltInModule} from '@zzzen/pyright-internal/dist/analyzer/typeDocStringUtils.js';
import {CallSignatureInfo, TypeEvaluator} from '@zzzen/pyright-internal/dist/analyzer/typeEvaluatorTypes.js';
import {printLiteralValue} from '@zzzen/pyright-internal/dist/analyzer/typePrinter.js';
import {CompletionMap} from '@zzzen/pyright-internal/dist/languageService/completionProvider.js';
import {
    ClassType,
    combineTypes,
    FunctionType,
    ...
    TypeBase,
    TypeCategory,
} from '@zzzen/pyright-internal/dist/analyzer/types.js';
import {
    containsLiteralType,
    doForEachSignature,
    doForEachSubtype,
    ...
    lookUpClassMember,
    MemberAccessFlags,
} from '@zzzen/pyright-internal/dist/analyzer/typeUtils.js';
import {throwIfCancellationRequested} from '@zzzen/pyright-internal/dist/common/cancellationUtils.js';
import {appendArray} from '@zzzen/pyright-internal/dist/common/collectionUtils.js';
import {ExecutionEnvironment} from '@zzzen/pyright-internal/dist/common/configOptions.js';
import * as debug from '@zzzen/pyright-internal/dist/common/debug.js';
import {fail} from '@zzzen/pyright-internal/dist/common/debug.js';
import {ProgramView} from '@zzzen/pyright-internal/dist/common/extensibility.js';
import {fromLSPAny, toLSPAny} from '@zzzen/pyright-internal/dist/common/lspUtils.js';
import {convertOffsetToPosition, convertPositionToOffset} from '@zzzen/pyright-internal/dist/common/positionUtils.js';
import {PythonVersion, pythonVersion3_10, pythonVersion3_5} from '@zzzen/pyright-internal/dist/common/pythonVersion.js';
import * as StringUtils from '@zzzen/pyright-internal/dist/common/stringUtils.js';
import {comparePositions, Position, TextRange} from '@zzzen/pyright-internal/dist/common/textRange.js';
import {TextRangeCollection} from '@zzzen/pyright-internal/dist/common/textRangeCollection.js';
import {Uri} from '@zzzen/pyright-internal/dist/common/uri/uri.js';
import {convertToTextEdits} from '@zzzen/pyright-internal/dist/common/workspaceEditUtils.js';
import {Localizer} from '@zzzen/pyright-internal/dist/localization/localize.js';
import {
    ArgumentCategory,
    DecoratorNode,
...
import {ParseFileResults} from '@zzzen/pyright-internal/dist/parser/parser.js';
import {
    FStringStartToken,
    OperatorToken,
    OperatorType,
    ...
    Token,
    TokenType,
} from '@zzzen/pyright-internal/dist/parser/tokenizerTypes.js';
import {
    AutoImporter,
    AutoImportResult,
    buildModuleSymbolsMap
} from '@zzzen/pyright-internal/dist/languageService/autoImporter.js';
import {
    CompletionDetail,
    getCompletionItemDocumentation,
    getTypeDetail,
    SymbolDetail,
} from '@zzzen/pyright-internal/dist/languageService/completionProviderUtils.js';
import {DocumentSymbolCollector} from '@zzzen/pyright-internal/dist/languageService/documentSymbolCollector.js';
import {
    getAutoImportText,
    getDocumentationPartsForTypeAndDecl
} from '@zzzen/pyright-internal/dist/languageService/tooltipUtils.js';
...
export class CompletionProvider {
    ...
    private _getCompletions(): CompletionMap | undefined {
        ...
        // precedence.
        /*  EDIT: We don't want to do this for the hallucination detector
